# Kirk Boyer, 2016-2017
# Most recent, updated version of this process as of Jan 19, 2017

# Set alpha (normalized angle between 0 and 1 (instead of 0 and pi) in the construction)
alpha <- 0.5

# Set weights according to proportion of rays in each group 
base_weight = 1
...
# Edges computed from spreadsheet; just the naive union of the two graphs
adjacencies <- read.csv("g_n_2_adj_matrix.csv") # make sure working directory is the same as the one containing this file
